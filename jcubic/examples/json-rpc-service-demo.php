...
class Demo {
  ...
  public function whoami($token) {
    return array("your Uuser Agent" => $_SERVER["HTTP_USER_AGENT"],
                 "your IP" => $_SERVER['REMOTE_ADDR'],
                 "you acces this from" => $_SERVER["HTTP_REFERER"]);
  }

  static $idezet_documentation = "return user information";
  public function idezet($token) {
    return array("hatha1" => $_SERVER["HTTP_USER_AGENT"]);
  }
}
