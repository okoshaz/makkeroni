...
(function($, undefined) {
    ...
    */
    ...
    $.terminal.defaults = {
        ...
        keydown: $.noop,
        strings: {
            wrongPasswordTryAgain: "Hibás jelszó! a demo jó! :)",
            wrongPassword: "Mondom hogy a demo a jelszó:)!",
            ajaxAbortError: "Error while aborting ajax call!",
            wrongArity: "Mást is kell kérned karácsonyra. A '%s' várna még %s-t is, de csak "+
                " %s-t kapott!",
            commandNotFound: "Neked is boldog %st!",
                ...
                if (ret.procs) {
                    ...
                    interpreter_object.help = interpreter_object.help || function(fn) {
                        if (typeof fn == 'undefined') {
                            self.echo('[[b;#f00;]Elérhető parancsok: ' + ret.procs.map(function(proc) {
                                return proc.name;
                            }).join(', ') + ', help]');
                        } else {
                            var found = false;
